...
export function Button({ children, className, variant = 'primary', size = 'md', ...rest }: ButtonProps): JSX.Element {
  const variantClasses = {
    primary: 'bg-primary text-lightGreen hover:bg-secondary',
    secondary: 'bg-secondary text-lightGreen hover:bg-primary',
    outline: 'border-2 border-primary text-primary hover:bg-primary hover:text-lightGreen'
  };
